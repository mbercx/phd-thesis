...
\textcolor{white}{\rule{1em}{0.3em}}
\ifthenelse{\equal{#3}{}}{}{%
\hyperref[appendix:sec-#3]{\includegraphics[width=2.5em]{figures/silicon3.png}}}
\end{minipage}
}{%
\ifthenelse{\equal{#3}{}}{%
\begin{minipage}{0.07\textwidth}
...
%% Print version -> Uncomment to override previous
