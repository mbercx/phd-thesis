...
\input{\figurepath/quotas/baragiola_calc}

\nextgroupplot[
xlabel={0.78 $E_I$ - 2 $\phi$ (eV)},
% ymin=0, ymax=1.2, 
% yticklabel pos=right,
legend style={
...
\input{\figurepath/quotas/baragiola_exp}
