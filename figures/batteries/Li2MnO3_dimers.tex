...
\node [anchor=south west] at (0, 0) {\includegraphics[height=0.3\textwidth]{\figurepath/batteries/Li2MnO3-d49_80.png}};
...
\input{\figurepath/batteries/neb_Li2MnO3-49_80-data}

\end{axis}

\node [font=\bfseries, anchor=north west] at (7.2, 4.6) {A};

\node (fig2) [anchor=south east] at (0.95\textwidth, -13em) {\includegraphics[height=0.3\textwidth]{\figurepath/batteries/Li2MnO3-d48_92.png}};
...
\input{\figurepath/batteries/neb_Li2MnO3-48_92-data}
