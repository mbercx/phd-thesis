...
\begin{figure}[hb]  
\centering 
\includegraphics[width=\textwidth]{\figurepath/slme/pv-evo.png} 
...
\includegraphics[width=0.38\textwidth]{\figurepath/slme/Intensity.png} 
...
\centering 
\includegraphics[width=1\linewidth]{\figurepath/slme/Direct.png} 
\caption{} 
\end{subfigure}% 
\begin{subfigure}{0.50\textwidth} 
\centering 
\includegraphics[width=1\linewidth]{\figurepath/slme/Indirect.png} 
\caption{} 
\end{subfigure} 
...
\vspace{-3em}
\centering 
\includegraphics[width=0.50\textwidth]{\figurepath/slme/RadRec.png} 
...
\begin{figure}[ht]  
\centering 
\includegraphics[width=0.7\textwidth]{\figurepath/slme/SQlimit.png} 
...
\begin{figure}[ht]  
\centering 
\includegraphics[width=0.7\textwidth]{\figurepath/slme/SLMEcalc.png} 
...
\resultsubsection{Structure and formation energy \label{slme:sec-structure}}{https://github.com/mbercx/phd-thesis/tree/master/jupyter/slme\#structure-and-formation-energy}{solar_structure} 
...
compounds.} 
\begin{tabular}{l@{\hskip 2 em}S[table-format=1.1]} 
...
\resultsubsection{Absorber layer efficiency \label{slme:sec-CuAu_efficiency}}{https://github.com/mbercx/phd-thesis/tree/master/jupyter/slme\#absorber-layer-efficiency}{solar_efficiency} 
...
\centering 
\captionsetup{width=0.8\textwidth}
\includegraphics[width=0.5\textwidth]{\figurepath/slme/diel_CuInS2.png} 
...
\centering
\captionsetup{width=0.9\textwidth}
\includegraphics[width=0.6\textwidth]{\figurepath/slme/slme.png} 
...
\centering 
\captionsetup{width=0.9\textwidth}
\includegraphics[width=0.6\textwidth]{\figurepath/slme/CuAu_thickness.png} 
...
\resultsubsection{The curious case of CA-CuInSe$_2$ \label{slme:sec-CuInSe2}}{https://github.com/mbercx/phd-thesis/tree/master/jupyter/slme\#the-curious-case-of-ca-cuinse_2}{solar_efficiency}  
...
dependence of the SLME for \mbox{CA-\ce{CuInSe2}} and \mbox{CA-\ce{CuGaS2}} 
...
the SQ limit, whereas that of \ce{CuGaS2} does not. 
 
% \begin{figure}[ht] 
% \centering 
% \captionsetup{width=0.9\textwidth}
% \includegraphics[width=0.6\textwidth]{\figurepath/slme/CA_thickness.png} 
...
% \centering 
% \captionsetup{width=0.9\textwidth}
% \includegraphics[width=0.56\textwidth]{\figurepath/slme/JV_CuInS2.png} 
...
% \centering 
% \captionsetup{width=0.9\textwidth}
% \includegraphics[width=0.56\linewidth]{\figurepath/slme/JV_thickness_1.png} \\\vspace{-0.5em}
% \includegraphics[width=0.56\linewidth]{\figurepath/slme/JV_thickness_2.png}	 
...
\input{\figurepath/slme/thickness_analysis1}
\end{subfigure}
~
\begin{subfigure}[t]{0.46\textwidth}
\input{\figurepath/slme/thickness_analysis2}
\end{subfigure}
\caption{(\textsf{\textbf{a}}) Thickness dependence of the SLME of CA-CuInSe$_2$ and CA-CuGaS$_2$ at 300~\si{\kelvin} versus their SQ limit. (\textsf{\textbf{b}}) Calculated $J$-$V$ characteristic of CA-CuInSe$_2$ at $T=300~\si{\kelvin}$ and $L = 500~\si{\nano\meter}$ (full line), as well as the corresponding power density (dashed line). (\textsf{\textbf{c}}-\textsf{\textbf{d}}) Thickness dependence of the current densities of CuInSe$_2$ and CuGaS$_2$, as well as the open circuit voltage $V_{oc})$ (\textsf{\textbf{e}}) versus their respective SQ values.}
...
circuit voltage $V_{oc}$. This is the case for both \ce{CuInSe2} and 
\ce{CuGaS2}. However, because the order of magnitude of $J_0$ is much 
larger for \ce{CuInSe2} than for \ce{CuGaS2}, the open circuit voltage $V_{oc}$ at low thicknesses is significantly larger than the corresponding Shockley-Queisser value for \ce{CuInSe2} than for \ce{CuGaS2}.

% Let's quantify this a little more: the SLME crosses the SQ limit when its maximum power density is higher than 
...
% \ce{CuGaS2} (Fig.~\ref{slme:fig-VJcomp}). In comparison, the 
...
% \begin{figure}[ht] 
% \centering 
% \includegraphics[width = 0.28\linewidth]{\figurepath/slme/J_V_ratios_1.png} 
% \includegraphics[width = 0.28\linewidth]{\figurepath/slme/J_V_ratios_2.png} 
...
\begin{figure}[ht] 
\centering 
\includegraphics[width=0.6\textwidth]{\figurepath/slme/CuInS2_highT.png} 
...
\resultsubsection{Logistic function model \label{slme:sec-logistic}}{https://github.com/mbercx/phd-thesis/tree/master/jupyter/slme\#logistic-function-model}{} 
...
\resultsubsection{Indirect band gap absorbers \label{slme:sec-indirect}}{https://github.com/mbercx/phd-thesis/tree/master/jupyter/slme\#indirect-band-gap-absorbers}{}
