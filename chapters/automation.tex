...
aborted using \gls{VASP}'s \vasp{STOPCAR} file (\code{max\_elec\_steps}). 
...
\code{Firetask} that actually performs the \gls{VASP} calculation, within a 
...
\code{Firetask} runs \gls{VASP} in the directory of the \code{Firework}. 
...
one \gls{VASP} calculation. As these \code{Firework}s are largely just a 
...
\resultsubsection{Optical properties \label{automation:sec-optics}}{https://github.com/mbercx/phd-thesis/tree/master/jupyter/automation/README.md\#optical-properties}{} 
...
\resultsubsection{Configurations \label{automation:sec-configurations}}{https://github.com/mbercx/phd-thesis/tree/master/jupyter/automation/README.md\#configurations}{} 
...
\resultsubsection{Kinetic barriers - dimer workflow \label{automation:sec-dimer}}{https://github.com/mbercx/phd-thesis/tree/master/jupyter/automation/README.md\#kinetic-barriers---dimer-workflow}{}  
...
\resultsubsection{Surface properties \label{automation:sec-surface}}{https://github.com/mbercx/phd-thesis/tree/master/jupyter/automation/README.md\#surface-properties}{}  
...
\resultsubsection{Landscapes \label{automation:sec-landscape}}{https://github.com/mbercx/phd-thesis/tree/master/jupyter/automation/README.md\#landscapes}{} 
...
\begin{figure}[ht] 
\input{\figurepath/automation/landscape_wf.tex} 
