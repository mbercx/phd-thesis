...
{plane wave basis}{\link{dft:sec-planewave}{plane wave basis}}
...
as implemented in the \dft{VASP}{}. This appendix starts with 
...
\subsubsection{Thermodynamic Stability of Sn substitution} \label{appendix:sec-sn_stability} 
...
\subsubsection{Influence of \ce{Mn^{4+}} substitution on oxygen stability} \label{appendix:sec-substitutions} 
