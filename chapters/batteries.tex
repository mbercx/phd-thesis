...
Section~\ref{batteries:sec-substitutions} deals with the solubility of \ce{Sn} 
...
oxygen-based cathodes (e.g. \ce{LiMn2O4}) have a lower capacity compared to 
...
use of liquid electrolytes. \todo[inline]{extend in case we include the 
...
battery cathodes. Adapted from~\cite{Rozier2015} \todo[inline]{Make my own 
figure!}} 
...
workflow described in Section~\ref{sec:automation-configurations}, resulting 
...
stacking at higher states of charge. In order to verify this transition from 
...
\ce{Li2IrO3} as the cathode is charged. The unit cell of the HSE06 calculation 
...
oxygen only starts to evolve from \ce{Li2IrO3} cathode once it is charged 
beyond 75\%, whereas \ce{Li2MnO3} has already lost oxygen at this state of 
...
theoretically for \ce{Li2MnO3}, and believed to be related the migration of Mn 
...
\resultsubsection{Oxidation}{https://mybinder.org/v2/gh/mbercx/jupyter/master?filepath=parallel\%2Fparallel_analysis.ipynb}{oxidation} \label{batteries:sec-oxidation}
...
and charged \ce{Li2[Mn, Ir]O3} structures, all expressed in $\mu_B$. Note that 
...
\todo[inline]{With the new PDOS figures (also showing the unoccupied states to 
a greater range, this discussion could be expanded.} 
...
package \todo[inline]{Refer to chapter on automation} to find the 
...
optimizations for \ce{O1-Li_{0.5}IrO3} result in a new geometry with a lower 
...
identified as \ce{Li2SnO3} based on an indexation of the XRD results [CHECK]. 
...
\subsection{Influence of \ce{Mn^{4+}} substitution on oxygen stability} 
\label{batteries:sec-dimer_substitution} 
 
The next question is whether the stability of the oxygen framework of 
\ce{Li2MnO3} can be improved by a local substitution of \ce{Mn^{4+}}. In order 
...
from the 2x2x2 supercell of the charged O1-\ce{Li_{0.5}MnO3} structure. Based 
on the results of the previous section, only a limited amount of \ce{Sn} can 
be substituted in~\ce{Li2MnO3} before we expect the cathode to separate in two 
...
higher states of oxidation and have shown promise in \ce{Li}-rich materials 
...
and charge for the \ce{Sn}/\ce{V}/\ce{Mo}-substituted structures, all 
...
(right) structures, for the 2x2x2 supercell of \ce{Li2MnO3} with a single 
substitution of \ce{Sn}, \ce{V} and \ce{Mo}.} 
\label{batteries:fig-substitution_pdos_pbeu} 
\end{figure} 
 
For \ce{V} and \ce{Mo}, the magnetic moments and projected density of states 
...
% It should be noted that because of convergence issues of the NEB 
...
\ce{V} and \ce{Mo}, both for the PBE+U and SCAN functional. \todo[inline]{Add 
barrier heights to images.}} 
...
\todo[inline]{@Dirk \& Bart: The conclusion still needs to be updated, I'll do 
that after we discuss the content of the chapter to make sure I'm not doing 
double work.} 
...
O1-\ce{Li0.5MnO3}. For O1-\ce{Li0.5IrO3}, we observe that the oxygen lattice 
...
can be explained by the mixed redox process for \ce{Li2IrO3}, which is also 
shown from the calculated magnetic moments. The lack of O-O dimer formation in 
O1-\ce{Li0.5IrO3} provides valuable insight as to why \ce{Li2IrO3} does not 
...
is much less likely in \ce{Li2IrO3}, which could explain the lack of voltage 
fade and oxygen evolution found for this material. 
 
the formation of O-O dimers for partially charged O1-\ce{Li2MnO3} using a 
...
similar calculations for partially charged O1-\ce{Li2IrO3}, a Li-rich material 
for which the voltage fade was not observed during cycling.  
 
Interestingly, McCalla et al. [CITE] found that for \ce{Li2IrO3}, the voltage 
fade found in \ce{Li2MnO3} is not observed, and that \ce{O2} release is 
limited and only occurs at very high states of charge. Understanding why these 
processes occur for \ce{Li2MnO3} but not for \ce{Li2IrO3} can help prevent the 
