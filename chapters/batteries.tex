...
battery~\tocite. Moreover, Chen and Islam contend that the O-O dimer is eventually 
...
identified as \ce{Li2SnO3} based on an indexation of the XRD results. \todo[inline]{Check with Mylene!}
...
recently introduced \link{dft:sec-metaGGA}{SCAN functional}~\cite{Sun2015}. 
...
the recently published \link{dft:sec-metaGGA}{SCAN functional}, in order to compare the results with 
those of \link{dft:sec-dudarev}{PBE+U}. As SCAN does not rely on specifying a parameter for each 
